...
- **Custom-made code.** Use special comments and templates to customize your Kotlin translation, and use platform-specific features even in translated source files.
...
- [Translating an iOS app to Android](https://vinivendra.github.io/Gryphon/translatingAniOSAppToAndroid.html)
