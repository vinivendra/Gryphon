...
class MutableArrayTest: XCTestCase {
	func testEquatable() {
		...
		let array2: MutableArray = [1, 2, 3]
		let array3: MutableArray = [4, 5, 6]
	...
	func testInits() {
		let array1: MutableArray = [1, 2, 3]
		let array2: MutableArray = MutableArray([1, 2, 3])
		let array3: MutableArray = MutableArray(array1)
		let sequence = AnySequence([1, 2, 3])
		let array4: MutableArray = MutableArray(sequence)
		let array5: MutableArray<Int> = MutableArray()
		...
		XCTAssertNotEqual(array1, array4)
	...
	func testToFixedArray() {
		let array1: MutableArray = [1, 2, 3]
		let array2: MutableArray = [1, 2, 3, 4]
		let fixedArray: FixedArray = array1.toFixedArray()
	...
	func testSubscript() {
		let array1: MutableArray = [1, 2, 3]
		let array2: MutableArray = [10, 2, 3]
		array1[0] = 10
	...
	func testHash() {
		let array1: MutableArray = [1, 2, 3]
		let array2: MutableArray = [1, 2, 3]
		let array3: MutableArray = [1, 2, 3, 4]
