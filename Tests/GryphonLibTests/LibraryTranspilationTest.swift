...
class LibraryTranspilationTest: XCTestCase {
	...
	func testSubtyping() {
		...
		XCTAssert("String".isSubtype(of: "_Hash"))
		XCTAssert("Int".isSubtype(of: "_Hash"))
		XCTAssert("Any".isSubtype(of: "_Hash"))
		XCTAssert("Box<Int>".isSubtype(of: "_Hash"))
		XCTAssert("Dictionary<Int, String>".isSubtype(of: "_Hash"))

		XCTAssert("String".isSubtype(of: "_Compare"))
		XCTAssert("Int".isSubtype(of: "_Compare"))
		XCTAssert("Any".isSubtype(of: "_Compare"))
		XCTAssert("Box<Int>".isSubtype(of: "_Compare"))
		XCTAssert("Dictionary<Int, String>".isSubtype(of: "_Compare"))
